...
public class CommandTestUtil {
    ...
    public static final String VALID_NAME_POPPY = "Poppy";
    public static final String VALID_NAME_THOMAS = "Thomas";
    ...
    public static final String NAME_DESC_POPPY = " " + PREFIX_NAME + VALID_NAME_POPPY;
    public static final String NAME_DESC_THOMAS = " " + PREFIX_NAME + VALID_NAME_THOMAS;
    ...
    public static final String NAME_DESC_DEFAULT = " " + PREFIX_NAME + DEFAULT_NAME;
    public static final String PHONE_DESC_DEFAULT = " " + PREFIX_PHONE + DEFAULT_PHONE;
